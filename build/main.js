        ...
        try {
            ...
            if (legacyGlobal && legacyGlobal.val !== void 0 && legacyGlobal.val !== null && legacyGlobal.val !== '') {
                ...
                if (safe) {
                    ...
                    this.log.warn(
                        `Migration: legacy global.visUrl rejected as unsafe \u2014 set global.manualUrl manually`,
                    );
                }
            }
        } catch {}
            ...
            try {
                ...
                if (legacy && legacy.val !== void 0 && legacy.val !== null && legacy.val !== '') {
                    ...
                    if (safe) {
                        ...
                        await this.setStateAsync(`clients.${record.id}.mode`, {
                            val: import_global_config.MODE_MANUAL,
                            ack: true,
                        });
    ...
    async onStateChange(id, state) {
        ...
        if (clientParsed) {
            if (clientParsed.kind === 'mode') {
                ...
                if (
                    (record == null ? void 0 : record.mode) === import_global_config.MODE_GLOBAL &&
                    this.globalConfig.resolveUrlFor(record) === null
                ) {
                    this.log.warn(
        ...
        const globalParsed = this.globalConfig
            ? (0, import_global_config.parseGlobalStateId)(id, this.namespace)
            : null;
